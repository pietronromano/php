...
```bash
cd /Users/macbookpro/dev/php/github/php/cogeigniter/08-install-shield/ci-app
...
- Set origin folder:
  ```bash
  origin_dir="/Users/macbookpro/dev/php/github/php/cogeigniter/08-install-shield/ci-app/"
  ```
